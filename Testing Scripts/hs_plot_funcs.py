...
def plot_QM12(regret, prob, action, opt, fc_invoked, theta_mse, treatment_pred, y_size = 5, x_size = 14, alpha = 0.005, title_end = "", t = 5):
    ...
    for week_num, in zip(range(max_day//7)):
        ...
        sns.kdeplot(x,ax = axes[0],label="Week %i"%(week_num+1),shade=True)
    axes[0].legend()
...
def plot_QM13(regret, prob, action, opt, fc_invoked, theta_mse, treatment_pred, y_size = 8, x_size = 15, alpha = 0.005, title_end = "", t = 5):
